               ...
               <div class="card-body">
                  ...
                  <ul class="list-group list-group-flush list-group-no-gutters">
                     ...
                     <li class="list-group-item py-3">
                        <div class="media">
                           <div class="mt-1 mr-3">
                              <img class="avatar avatar-xs avatar-4by3" src="<?= BASE_URL ?>\public\template\svg\brands\capsule.svg" alt="Image Description">
                           </div>
                     ...
                     <li class="list-group-item py-3">
                        <div class="media">
                           <div class="mt-1 mr-3">
                              <img class="avatar avatar-xs avatar-4by3" src="<?= BASE_URL ?>\public\template\svg\brands\mailchimp.svg" alt="Image Description">
                           </div>
                           <div class="media-body">
                              <div class="row align-items-center">
                                 <div class="col">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="table-column-pl-0">
                        <a class="media align-items-center" href="user-profile.html">
                           <div class="avatar avatar-sm avatar-circle mr-2">
                              <img class="avatar-img" src="<?= BASE_URL ?>\public\template\img\160x160\img9.jpg" alt="Image Description">
                           </div>
                           <div class="media-body">
                  ...
                  <tr>
                     ...
                     <td class="table-column-pl-0">
                        <a class="media align-items-center" href="user-profile.html">
                           <div class="avatar avatar-sm avatar-circle mr-2">
                              <img class="avatar-img" src="<?= BASE_URL ?>\public\template\img\160x160\img4.jpg" alt="Image Description">
                           </div>
                           <div class="media-body">
            ...
            <div class="form-row">
               ...
               <div class="col-auto">
                  <a class="d-flex align-items-center font-size-sm text-body" href="#">
                     <img class="avatar avatar-xss mr-2" src="<?= BASE_URL ?>\public\template\svg\brands\gmail.svg" alt="Image Description">
                     Import contacts
                  </a>
               </div>
            </div>
...
<script src="<?= BASE_URL ?>\public\template\vendor\chart.js.extensions\chartjs-extensions.js"></script>
<script src="<?= BASE_URL ?>\public\template\vendor\chartjs-plugin-datalabels\dist\chartjs-plugin-datalabels.min.js"></script>
<!-- JS Front -->
