        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    <!-- Logo -->
                    <a class="navbar-brand" href="<?= BASE_URL ?>/login" aria-label="Front">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu ">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                ...
                                <li class="navbar-vertical-aside-has-menu ">
                                    ...
                                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                        <li class="nav-item">
                                            <a class="nav-link " href="<?= BASE_URL ?>/admin/statistics" title="Overview">
                                                <span class="tio-circle-outlined nav-indicator-icon"></span>
                                                <span class="text-truncate">Overview</span>
                                            </a>
                                        </li>
                                        <li class="navbar-vertical-aside-has-menu ">
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/product/list_product" title="Products">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-truncate">Products</span>
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/product/add_product" title="Add Product">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                        ...
                                        <li class="navbar-vertical-aside-has-menu ">
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/product/list_category" title="Orders">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-truncate">Categories</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/product/add_category" title="Order Details">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                        ...
                                        <li class="navbar-vertical-aside-has-menu ">
                                            ...
                                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/customer" title="Customers">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span class="text-truncate">Customers</span>
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link " href="<?= BASE_URL?>/customer/add_customer" title="Add Customers">
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="<?= BASE_URL?>/review" title="Manage Reviews">
                                                <span class="tio-circle-outlined nav-indicator-icon"></span>
                        ...
                        <li class="navbar-vertical-aside-has-menu nav-footer-item ">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle " href="javascript:;" title="Language">
                                <img class="avatar avatar-xss avatar-circle" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\us.svg" alt="United States Flag">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="English (US)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\us.svg" alt="Flag">
                                        English (US)
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="English (UK)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\gb.svg" alt="Flag">
                                        English (UK)
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Deutsch">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\de.svg" alt="Flag">
                                        Deutsch
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Dansk">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\dk.svg" alt="Flag">
                                        Dansk
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="Italiano">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\it.svg" alt="Flag">
                                        Italiano
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#" title="中文 (繁體)">
                                        <img class="avatar avatar-xss avatar-circle mr-2" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\cn.svg" alt="Flag">
                                        中文 (繁體)
                                    </a>
                                </li>
                            </ul>
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand d-flex justify-content-center">
                ...
                <a class="navbar-brand" href="index.html" aria-label="Front">
                    <img class="navbar-brand-logo-short" src="<?= BASE_URL ?>\public\template\svg\logos\logo-short.svg" alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
            <!-- Content -->
...
<script src="<?= BASE_URL ?>\public\template\js\demo.js"></script>
<!-- END ONLY DEV -->
<!-- Search Form -->
