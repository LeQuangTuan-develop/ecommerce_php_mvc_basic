...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    <!-- Page Header -->
    <form action="<?= BASE_URL?>/product/insert_product" method="post" enctype="multipart/form-data" name="formInsert">
          ...
          <div class="card-body">
            ...
            <div class="quill-custom">
                <div class="js-quill" style="min-height: 15rem;" data-hs-quill-options='{
                    ...
                    <textarea name="descriptionQuill" cols="30" rows="10"></textarea>               
                </div>
              </div>
              <!-- End Quill -->
              <textarea name="description" id="descriptionProduct" cols="" rows="" style="display: none"></textarea> 
          </div>
          <!-- Body -->
        </div>
        <!-- End Card -->
        ...
        <div class="card-body">
          <div class="row justify-content-center justify-content-sm-between">
            ...
            <div class="col-auto">
              ...
              <button type="submit" class="btn btn-primary btn-insert-product">Save</button>
            </div>
          </div>
          <!-- End Row -->
        </div>
...
<script>
  $(document).on('ready', function() {
    ...
    var btn_insert_product = document.querySelector('.btn-insert-product')
    var formInsert = document.forms['formInsert']
    
    btn_insert_product.addEventListener('click', (e) => {
      e.preventDefault();
      var description = document.querySelector('.ql-editor').innerText
