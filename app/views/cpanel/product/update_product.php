<main id="content" role="main" class="main">
  <!-- Content -->
  <form action="" id="form-update-product" data-id="<?php {{ echo $product['product_id']; }}?>" method="post" enctype="multipart/form-data">
      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title"><?php {{ echo $product['product_name']; }}?></h1>
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" rules="required" name="productName" id="productNameLabel" placeholder="Shirt, t-shirts, etc." aria-label="Shirt, t-shirts, etc." value="<?php {{ echo $product['product_name']; }}?>">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="SKU" id="SKULabel" placeholder="eg. 348121032" aria-label="eg. 348121032" value="<?php {{ echo $product['product_code']; }}?>">
                  </div>
                  <!-- End Form Group -->
                </div>
              ...
              <!-- End Quill -->
              <textarea name="description" id="descriptionProduct" cols="" rows="" style="display: none"><?php {{ echo $product['description']; }}?></textarea> 
            </div>
            <!-- Body -->
          </div>
          <!-- End Card -->
            ...
            <div class="card-body">
              ...
              <div id="fancyboxGallery" class="js-fancybox row justify-content-sm-center gx-2" data-hs-fancybox-options='{
                ...
                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                  ...
                  <div class="card card-sm">
                    <img class="card-img-top" src="<?= BASE_URL?>\public\images\products\<?php {{ echo $product['image'];}}?>" alt="Image Description">

                    <div class="card-body">
                      <div class="row text-center">
                        <div class="col">
                          <a class="js-fancybox-item text-body" href="javascript:;" data-toggle="tooltip" data-placement="top" title="View" data-src="<?= BASE_URL?>\public\template/img/725x1080/img1.jpg" data-caption="Image #01">
                ...
                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                  <!-- Card -->
                  <div class="card card-sm">
                    <img class="card-img-top" src="<?= BASE_URL?>\public\images\products\<?php {{ echo $img['image'];}}?>" alt="Image Description">
              ...
              <div id="drop-area">
                  <form class="my-form">
                      ...
                      <p>Choose file or drop file to upload</p>
                      <input type="file" id="fileElem" name="fileImg" multiple accept="image/*">
                      <label class="button-input-files" for="fileElem">Browse files</label>
                  </form>
              </div>
              <!-- End Dropzone -->
            </div>
          ...
          <div class="js-add-field card mb-3 mb-lg-5" data-hs-add-field-options='{
              ...
              <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                ...
                <tbody id="addVariantsContainer">
                  <tr>
                    ...
                    <th>
                      <img class="avatar" src="<?= BASE_URL?>\public\template\img\400x400\img7.jpg" alt="Image Description">
                    </th>
            ...
            <table style="display: none;">
              <tr id="addVariantsTemplate">
                ...
                <th>
                  <img class="avatar" src="<?= BASE_URL?>\public\template\img\400x400\img2.jpg" alt="Image Description">
                </th>
                <th class="table-column-pl-0">
        ...
        <div class="col-lg-4">
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
              <!-- Form Group -->
              <div class="form-group">
                <label for="priceProductLabel" class="input-label">Price</label>

                <div class="input-group">
                  <input type="text" class="form-control" rules="required" name="productPrice" id="priceProductLabel" placeholder="0.00" aria-label="0.00" value="<?php {{ echo number_format($product['list_price'], 0, ',', '.'); }}?>">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <!-- Form Group -->
              <div class="form-group">
                <label for="supplierLabel" class="input-label">Vendor</label>
                ...
                <select class="js-select2-custom custom-select" name="supplierProductId" size="1" style="opacity: 0;" id="supplierLabel" data-hs-select2-options='{
                  ...
                  <option value="<?php {{ echo $item['supplier_id']; }}?>" <?php {{ echo ($item['supplier_id'] == $product['supplier_id']) ? 'selected=""' : ''; }}?>><?php {{ echo $item['supplier_name']; }}?></option>  
                  <?php endforeach; ?>
                </select>
                <!-- End Select -->
              </div>
              ...
              <div class="form-group">
                ...
                <select class="js-select2-custom custom-select" name="categoryProductId" size="1" style="opacity: 0;" id="categoryLabel" data-hs-select2-options='{
                  ...
                  <option value="<?php {{ echo $item['category_id']; }}?>" <?php {{ echo ($item['category_id'] == $product['category_id']) ? 'selected=""' : ''; }}?>><?php {{ echo $item['category_name']; }}?></option>  
                  <?php endforeach; ?>
                </select>
                <!-- End Select -->
              </div>
      ...
      <div class="card card-sm bg-dark border-dark mx-2">
        <div class="card-body">
          <div class="row justify-content-center justify-content-sm-between">
            <div class="col">
              <a href="" type="submit" class="btn btn-ghost-danger">Delete</a>
            </div>
            <div class="col-auto">
              <button type="button" class="btn btn-ghost-light mr-2">Discard</button>
              <button type="submit" class="btn btn-primary btn-update-product">Save</button>
            </div>
          </div>
          <!-- End Row -->
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?= BASE_URL?>\public\template\svg\illustrations\choice.svg" alt="Image Description">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?= BASE_URL?>\public\template\svg\illustrations\presenting.svg" alt="Image Description">
        ...
        <!-- Media -->
        <div class="d-sm-flex">
          <img class="avatar avatar-xl avatar-4by3 mb-3 mb-sm-0 mr-4" src="<?= BASE_URL?>\public\template\svg\illustrations\book.svg" alt="Image Description">
...
<script src="<?= BASE_URL ?>/public/js/upload.js"></script>
