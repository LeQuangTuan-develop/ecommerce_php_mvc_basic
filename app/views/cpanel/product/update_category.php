    ...
    <div class="row">
      ...
      <div class="mx-auto col-lg-8">
        ...
        <div class="card">
          <!-- Body -->
          <div class="card-body">
            <form action="<?= BASE_URL ?>/product/update_category/<?php {{ echo $category['category_id'];}} ?>" method="post">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form Group -->
                  <div class="form-group">
                    <label for="firstNameLabel" class="input-label">Tên danh mục</label>
                    <input type="text" class="form-control" name="CateName" value="<?php {{ echo $category['category_name'];}} ?>" id="firstNameLabel" placeholder="danh mục" aria-label="Clarice">
                  </div>
                  <!-- End Form Group -->
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="CateCode" value="<?php {{ echo $category['category_code'];}} ?>" id="lastNameLabel" placeholder="DT001" aria-label="Boone">
                  </div>
                  <!-- End Form Group -->
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="exampleFormControlTextarea1" name="CateDescription" class="form-control" placeholder="mô tả ..." rows="4"><?php {{ echo $category['cate_description'];}} ?></textarea>
              </div>
