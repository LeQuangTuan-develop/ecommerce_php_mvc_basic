...
<main id="content" role="main" class="main">
  ...
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row align-items-center mb-3">
        ...
        <div class="col-sm-auto">
          <a class="btn btn-primary" href="<?= BASE_URL ?>/product/add_product">Add product</a>
        </div>
      </div>
      <!-- End Row -->
      ...
      <div class="col-lg">
        ...
        <div id="datatableCounterInfo" style="display: none;">
          <div class="d-sm-flex justify-content-lg-end align-items-sm-center">
            ...
            <button id="btn-delete-all" class="btn btn-sm btn-outline-danger mb-2 mb-sm-0 mr-2" data-toggle="modal" data-id="all" data-target="#delete-all-course-modal">
    ...
    <!-- Card -->
    <form action="<?= BASE_URL ?>/product/delete_product/all" name="containerForm" method="post">
    <div class="card">
      <!-- Header -->
          ...
          <tbody>
            ...
            <tr>
              <td class="table-column-pr-0">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" value="<?php {{ echo $value['product_id']; }}?>" name="productCheckbox[]" id="productsCheck<?php {{ echo $value['product_id']; }}?>">
                  <label class="custom-control-label" for="productsCheck<?php {{ echo $value['product_id']; }}?>"></label>
                </div>
              </td>
              <td class="table-column-pl-0" style=" max-width: 200px; overflow: hidden; text-overflow: ellipsis;">
                <a class="media align-items-center" href="<?= BASE_URL?>/product/edit_product/<?php {{ echo $value['product_id']; }}?>">
                  <img class="avatar avatar-lg mr-3" src="<?= BASE_URL ?>/public/images/products/<?php {{ echo $value['image']; }}?>" alt="Image Description">
                  <div class="media-body">
                    <h5 class="text-hover-primary mb-0"><?php {{ echo $value['product_name']; }}?></h5>
                  </div>
                </a>
              </td>
              ...
              <td>Google</td>
              <td>
                <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox<?php {{ echo $value['product_id']; }}?>">
                  <input type="checkbox" class="toggle-switch-input" id="stocksCheckbox<?php {{ echo $value['product_id']; }}?>" <?php {{ echo ($value['discontinued'] == 0) ? 'checked = ""': ''; }} ?>>
                  <span class="toggle-switch-label">
                    <span class="toggle-switch-indicator"></span>
                  </span>
                </label>
              ...
              <td><?php {{ echo number_format($value['list_price']); }}?></td>
              <td style=" max-width: 100px; overflow: hidden; text-overflow: ellipsis;"><?php {{ echo $value['quantity_per_unit']; }}?></td>
              <td>2</td>
              <td>
                <div class="btn-group" role="group">
                  <a class="btn btn-sm btn-white" href="<?= BASE_URL ?>/product/edit_product/<?php {{ echo $value['product_id']; }}?>">
                  ...
                  <div class="hs-unfold btn-group">
                    <a class="js-hs-unfold-invoker btn btn-icon btn-sm btn-white dropdown-toggle dropdown-toggle-empty" href="javascript:;" data-hs-unfold-options='{
                             "target": "#productsEditDropdown<?php {{ echo $value['product_id']; }}?>",
                             "type": "css-animation",
                             "smartPositionOffEl": "#datatable"
                           }'></a>

                    <div id="productsEditDropdown<?php {{ echo $value['product_id']; }}?>" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right mt-1">
                      <button class="dropdown-item" type="button" data-toggle="modal" data-id="<?php {{ echo $value['product_id']; }}?>" data-target="#delete-course-modal">
                        <i class="tio-delete-outlined dropdown-item-icon"></i> Delete
                          </button>
                      <a class="dropdown-item" href="<?= BASE_URL ?>/product/update_product/<?php {{ echo $value['product_id']; }}?>">
            ...
            <div class="step-content">
              ...
              <ul class="list-group list-group-sm">
                <li class="list-group-item list-group-item-light">
                  <div class="row gx-1">
                    <div class="col">
                      <img class="img-fluid rounded ie-sidebar-activity-img" src="<?= BASE_URL ?>\public\template\svg\illustrations\card-1.svg" alt="Image Description">
                    </div>
                    <div class="col">
                      <img class="img-fluid rounded ie-sidebar-activity-img" src="<?= BASE_URL ?>\public\template\svg\illustrations\card-2.svg" alt="Image Description">
                    </div>
                    <div class="col">
                      <img class="img-fluid rounded ie-sidebar-activity-img" src="<?= BASE_URL ?>\public\template\svg\illustrations\card-3.svg" alt="Image Description">
                    </div>
...
<!-- Delete Modal -->
<div class="modal fade" id="delete-course-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- Modal delete All -->
<div class="modal fade" id="delete-all-course-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Xóa sản phẩm</h5>
      ...
      <div class="modal-body">
        Bạn muốn xóa sản phẩm đã chọn này?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-submit-delete-product">Xóa</button>
        <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
      ...
      <div class="modal-footer d-block text-center py-sm-5">
        ...
        <div class="w-85 mx-auto">
          <div class="row justify-content-between">
            <div class="col">
              <img class="img-fluid ie-welcome-brands" src="<?= BASE_URL ?>\public\template\svg\brands\gitlab-gray.svg" alt="Image Description">
            </div>
            <div class="col">
              <img class="img-fluid ie-welcome-brands" src="<?= BASE_URL ?>\public\template\svg\brands\fitbit-gray.svg" alt="Image Description">
            </div>
            <div class="col">
              <img class="img-fluid ie-welcome-brands" src="<?= BASE_URL ?>\public\template\svg\brands\flow-xo-gray.svg" alt="Image Description">
            </div>
            <div class="col">
        ...
        <div class="form-group">
          ...
          <div id="attachFilesNewProjectLabel" class="js-dropzone dropzone-custom custom-file-boxed">
            <div class="dz-message custom-file-boxed-label">
              <img class="avatar avatar-xl avatar-4by3 mb-3" src="<?= BASE_URL ?>\public\template\svg\illustrations\browse.svg" alt="Image Description">
...
<script>
  $(document).on('ready', function() {
    ...
    var datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
      ...
      language: {
        zeroRecords: '<div class="text-center p-4">' +
          '<img class="mb-3" src="http://localhost/blog_ecommerce/public/template/svg/illustrations/sorry.svg" alt="Image Description" style="width: 7rem;">' +
    ...
    var productId;
    var btnDeleteProduct = document.querySelector('.btn-delete-product')
    var deleteForm = document.forms['delete-course-form']
    var submitBtnDelete = document.querySelector('.btn-submit-delete-product')
    ...
    btnDeleteProduct.addEventListener('click', () => {
      deleteForm.action = `<?= BASE_URL ?>/product/delete_product/${productId}`;
      deleteForm.submit();
    })

    submitBtnDelete.addEventListener('click', () => {
...
<!-- IE Support -->
<script>
  if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="http://localhost/blog_ecommerce/public/template/vendor/babel-polyfill/polyfill.min.js"><\/script>');
</script>
</body>
