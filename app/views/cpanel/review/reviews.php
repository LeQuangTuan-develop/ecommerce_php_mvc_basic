<main id="content" role="main" class="main">
          ...
          <div class="row align-items-md-center gx-md-5">
            <div class="col-md-auto mb-3 mb-md-0">
              <div class="d-flex align-items-center">
                <img class="avatar avatar-xxl avatar-4by3 mr-4" src="<?= BASE_URL?>\public\template\\svg\illustrations\review-5-star.svg"
                ...
                <div class="hs-unfold mr-2">
                  ...
                  <div id="usersExportDropdown"
                    ...
                    <a id="export-copy" class="dropdown-item" href="javascript:;">
                      <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?= BASE_URL?>\public\template\\svg\illustrations\copy.svg"
                        alt="Image Description">
                      Copy
                    </a>
                    <a id="export-print" class="dropdown-item" href="javascript:;">
                      <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?= BASE_URL?>\public\template\\svg\illustrations\print.svg"
                        alt="Image Description">
                      Print
                    </a>
                    ...
                    <a id="export-excel" class="dropdown-item" href="javascript:;">
                      <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?= BASE_URL?>\public\template\\svg\brands\excel.svg"
                        alt="Image Description">
                      Excel
                    </a>
                    <a id="export-csv" class="dropdown-item" href="javascript:;">
                      <img class="avatar avatar-xss avatar-4by3 mr-2"
                        src="<?= BASE_URL?>\public\template\\svg\components\placeholder-csv-format.svg" alt="Image Description">
                      .CSV
                    </a>
                    <a id="export-pdf" class="dropdown-item" href="javascript:;">
                      <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?= BASE_URL?>\public\template\\svg\brands\pdf.svg"
                        alt="Image Description">
                      PDF
                    </a>
                  </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <th>
                  ...
                  <?php if($product['product_id'] == $review['product_id']): ?>
                  <a class="d-flex align-items-center" href="<?= BASE_URL ?>/product/edit_product/<?php  {{ echo $product['product_id']; }} ?>">
                    <div class="avatar">
                      <img class="avatar-img" src="<?= BASE_URL?>\public\images\products\<?php  {{ echo $product['image']; }} ?>" alt="Image Description">
                    </div>
                    <div class="ml-3" style="max-width: 200px; overflow: hidden;text-overflow: ellipsis; ">
                ...
                <td>
                  ...
                  <?php if($customer['customer_id'] == $review['customer_id']): ?>
                  <a class="d-flex align-items-center" href="<?= BASE_URL ?>/customer/update_customer/<?php  {{ echo $customer['customer_id']; }} ?>">
                    <div class="avatar avatar-circle">
                      <img class="avatar-img" src="<?= BASE_URL?>\public\images\customers\<?php  {{ echo $customer['avatar']; }} ?>" alt="Image Description">
                    </div>
                    <div class="ml-3">
                      <span class="d-block h5 text-hover-primary mb-0"><?php  {{ echo $customer['last_name']; }} ?> <?php  {{ echo $customer['first_name']; }} ?></span>
                      <span class="d-block font-size-sm text-body"><?php  {{ echo $customer['email']; }} ?></span>
                    </div>
                  </a>
                  <?php endif; ?>
                  <?php endforeach; ?>
                  ...
                  <div class="text-wrap" style="width: 18rem;">
                    <div class="d-flex mb-2">
                      <?php for ($i=0; $i < $review['rating']; $i++): ?> 
                        <div class="mr-1"><img src="<?= BASE_URL?>\public\template\\svg\components\star.svg" alt="Review rating" width="14"></div>
                      <?php endfor; ?>
                      <?php for ($i=0; $i < 5 - $review['rating']; $i++): ?>
                        <div class="mr-1"><img src="<?= BASE_URL?>\public\template\\svg\components\star-muted.svg" alt="Review rating" width="14"></div>
                      <?php endfor; ?>
                    </div>
                  ...
                  <div class="hs-unfold">
                    <a class="js-hs-unfold-invoker btn btn-icon btn-sm btn-ghost-secondary rounded-circle"
                      href="javascript:;" data-hs-unfold-options='{
                           "target": "#settingsDropdown<?php  {{ echo $review['review_id']; }} ?>",
                           "type": "css-animation"
                         }'>
                      <i class="tio-more-horizontal"></i>
                    </a>

                    <div id="settingsDropdown<?php  {{ echo $review['review_id']; }} ?>"
                      ...
                      <a class="dropdown-item" href="<?= BASE_URL ?>/review/delete_review/<?php  {{ echo $review['review_id']; }} ?>">
  ...
  <!-- Upload files Modal -->
  <div class="modal fade" id="uploadFilesModal" tabindex="-1" role="dialog" aria-labelledby="uploadFilesModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <!-- Header -->
        ...
        <div class="modal-body">
          ...
          <div id="attachFilesLabel" class="js-dropzone dropzone-custom custom-file-boxed">
            <div class="dz-message custom-file-boxed-label">
              <img class="avatar avatar-xl avatar-4by3 mb-3" src="<?= BASE_URL?>\public\template\\svg\illustrations\browse.svg"
                alt="Image Description">
      ...
      var datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
        ...
        language: {
          zeroRecords: '<div class="text-center p-4">' +
            '<img class="mb-3" src="./<?= BASE_URL?>\public\template\/svg/illustrations/sorry.svg" alt="Image Description" style="width: 7rem;">' +
  ...
  <!-- IE Support -->
  <script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="./<?= BASE_URL?>\public\template\/vendor/babel-polyfill/polyfill.min.js"><\/script>');
  </script>
</body>
