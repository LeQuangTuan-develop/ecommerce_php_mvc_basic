      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title"><?php {{echo $value['last_name'];}}?> <?php {{echo $value['first_name'];}}?></h1>
          </div>

          <div class="col-sm-auto">
            <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle mr-1" href="#" data-toggle="tooltip"
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center mb-5">
                <div class="avatar avatar-lg avatar-circle">
                  <img class="avatar-img" src="<?= BASE_URL ?>/public/images/customers/<?php {{echo $value['avatar'];}}?>" alt="Image Description">
                </div>

                <div class="mx-3">
                  <div class="d-flex mb-1">
                    <h3 class="mb-0 mr-3"><?php {{echo $value['last_name'];}}?> <?php {{echo $value['first_name'];}}?></h3>

                    <!-- Unfold -->
                    <div class="hs-unfold">
                      <a class="js-hs-unfold-invoker btn btn-icon btn-xs btn-white rounded-circle" href="javascript:;"
                        data-toggle="tooltip" data-placement="top" title="Edit" data-hs-unfold-options='{
                             "target": "#editDropdown",
                             "type": "css-animation"
                           }'>
                        <i class="tio-edit"></i>
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-body">
                       ...
                       "marker": [
                         {
                           "coords": [37.4040344, -122.0289704],
                           "icon": {
                             "iconUrl": "http://localhost/blog_ecommerce/public/template/svg/components/map-pin.svg",
                             "iconSize": [50, 45]
                           },
                           "popup": {
              ...
              <span class="d-block">
                ...
                Latheronwheel<br>
                KW5 8NW, London<br>
                UK <img class="avatar avatar-xss avatar-circle ml-1" src="<?= BASE_URL ?>\public\template\vendor\flag-icon-css\flags\1x1\gb.svg"
        ...
        <div class="modal-body pt-3 pb-sm-5 px-sm-5">
          ...
          <div class="row mb-6">
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="d-flex align-items-center">
                <img class="avatar avatar-xss avatar-4by3 mr-2" src="<?= BASE_URL ?>\public\template\svg\brands\mastercard.svg"
                  alt="Image Description">
          ...
          <p class="modal-footer-text">If you have any questions, contact us at <a
              href="mailto:example@gmail.com">example@gmail.com</a> or call at <a href="#">+1 898 34-5492</a></p>
        </div>
        <!-- End Body -->
      </div>
    </div>
