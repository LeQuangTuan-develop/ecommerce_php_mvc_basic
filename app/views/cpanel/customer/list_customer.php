        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="<?= BASE_URL ?>/customer/add_customer">Add customers</a>
                </div>
            </div>
            <!-- End Row -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="table-column-pl-0">
                                <a class="d-flex align-items-center" href="<?= BASE_URL ?>/customer/detail_customer/<?php {{echo $customer['customer_id'];}}?>">
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img" src="<?= BASE_URL?>\public\images\customers\<?php {{echo $customer['avatar'];}}?>" alt="Image Description">
                                    </div>
                                    <div class="ml-3">
                                        <span class="h5 text-hover-primary"><?php {{echo $customer['last_name'];}}?> <?php {{echo $customer['first_name'];}}?></span>
                                    </div>
                                </a>
                            </td>
                            <td><?php {{echo $customer['email'];}}?></td>
                            <td><?php {{echo $customer['phone'];}}?></td>
                            <td><?php {{echo $customer['country'];}}?><span class="text-hide">Code: GB</span></td>
                            <td>
